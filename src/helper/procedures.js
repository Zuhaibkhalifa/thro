export default function procedures(procedure, handleProcedure, validator, showValidator = true) {
    return (
        <div className="form-group">
            ...
            >
                ...
                <optgroup label="Cardiac or vascular">
                    ...
                    <option value="Permanent pacemaker or ICD placement (if patient is on apixaban, edoxaban, rivaroxaban, or dabigatran – mod, if on any other drugs - low)">
                        Permanent pacemaker or ICD placement (if patient is on apixaban, edoxaban, rivaroxaban, or
                        dabigatran – mod, if on any other drugs - low)
                    </option>
            ...
            {showValidator ? validator.message('', procedure, 'required') : ''}
        </div>
    );
}
