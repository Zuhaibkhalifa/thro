...
export default async function thromboAlgo() {
    ...
    function indicationBleedingRiskAlgo() {
        ...
        const mapIndicationData = () => {
            ...
            variables['Stroke_btwn_1_3'] =
                res.stroke_or_mini_stroke == 'Yes' && res.stroke_how_long == 'Between 1 and 3 months ago'
                    ? true
                    : false;
    ...
    function patientBleedingRiskAlgo() {
        const mapPatientData = () => {
            ...
            variables['CrCl'] = round2Decimal(
                CrCl(res.age, res.weight, res.weight_unit, res.gender, res.poc_creat_text)
            );
