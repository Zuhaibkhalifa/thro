...
signin(param){
  ...
  axios.post('http://thrombolink.com/server/api/auth/reset', param,)
  .then((response) => {
  ...
  <div className="col-md-6 offset-md-3 blue-bg blue-box">
    ...
    <form className="text-center p-5" action="#!">
      ...
      <input
        ...
        id="defaultLoginFormPassword"
        className="form-control mb-4 blue-custom-input"
        placeholder="Confirm Password"  type="password" value={this.state.password_confirmation} onChange={(e)=>this.setState({password_confirmation:e.target.value})}
      />
