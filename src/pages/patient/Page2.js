...
class Page2 extends React.Component {
  constructor(props) {
    ...
    weight_unit:'',physicianName:'',
    weightSelected:'',unit_weight:'',
    ...
    element.classList.add("blue-bg");
      ...
      try {
         ...
         axios.get('http://thrombolink.com/server/api/patient/page2LoadData',{
          headers: headers
        })
        .then((response) => {
      ...
      <div className="form-row mb-4">
        <div className="col-4">
          ...
          <input
            ...
            maxlengt="2"
            defaultValue={this.state.age} onChange={(e)=>this.setState({age:e.target.value})}
          />
           {this.validator.message('age', this.state.age, ['required', {regex: '(1[89]|[2-9][0-9]|10[0-9]|110)'}])}
        </div>
        <div className="col-4">
          {/* Last name */}
...
{this.validator.message('gender', this.state.genderSelected, 'required')}
        ...
        <label htmlFor="age" className="blue">
          ...
          <input
            ...
            defaultValue={this.state.physicianName} onChange={(e)=>this.setState({physicianName:e.target.value})}
          />
