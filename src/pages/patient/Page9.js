...
class Page9 extends React.Component {
   ...
   submitForm() {
      if (
         ...
         document.getElementById("medicien1").checked === true &&
         $("#dosage1").val() === "" &&
         document.getElementById("notsure1").checked === false
      ) {
         this.setState({ error1: "", error2: "This field is required" });
      } else if (
         document.getElementById("medicien2").checked === true &&
         $("#dosage2").val() === "" &&
         document.getElementById("notsure2").checked === false
      ) {
         this.setState({
            error1: "",
            error2: "",
         ...
         document.getElementById("medicien3").checked === true &&
         $("#dosage3").val() === "" &&
         document.getElementById("notsure3").checked === false
      ) {
         this.setState({
            error1: "",
            error2: "",
                  ...
                  <form className="p-5" action="#!" id="frm">
                     ...
                     <div id="one">
                        ...
                        <input
                           ...
                           onClick={(e) => this.setState({ notsure1: "Not Sure" })}
                        />
                     ...
                     <div id="two">
                        ...
                        <input
                           ...
                           value="Not Sure"
                           onChange={this.toggle}
                           onClick={(e) => this.setState({ notesure2: "Not Sure" })}
                        />
                        <div className="text-danger">
                           {" "}
                     ...
                     <div id="four">
                        ...
                        <input
                           ...
                           value="Not Sure"
                           onChange={this.toggle}
                           onClick={(e) => this.setState({ notsure3: "Not Sure" })}
                        />
                        <div className="text-danger">
                           {" "}
                     ...
                     <div className="checkbox">
                        ...
                        <input
                           ...
                           onChange={(e) => this.setState({ q4_ans: e.target.value })}
                           onClick={this.no_med}
                           name="main_opt5"
