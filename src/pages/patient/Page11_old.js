...
class Page11 extends React.Component {
    ...
    brillinta_dose2() {
        if (document.getElementById('brillinta_dosage3').checked === true) {
            $('#brillinta_dose_other').show(1000);
        } else {
            $('#brillinta_dose_other').hide(1000);
        }
    }
    prasugrel_dose3() {
        if (document.getElementById('prasugrel_dosage3').checked === true) {
            $('#efffient_other').show(1000);
        } else {
            $('#efffient_other').hide(1000);
        }
    }
    ...
    submitForm() {
        if (
            ...
            !$("input[name='brillinta_dose']:checked").val()
        ) {
            ...
            document.getElementById('brillinta_dosage3').checked === true &&
            $('#brillinta_dose_other_opt').val() === ''
        ) {
            ...
            document.getElementById('medicien_3').checked === true &&
            !$("input[name='brillinta_dose_freq']:checked").val()
        ) {
            this.setState({ error6: '' });
            this.setState({ error7: '' });
                        ...
                        <form className="p-5" action="#!" id="frm">
                            ...
                            <div id="three">
                                ...
                                <input
                                    type="radio"
                                    name="brillinta_dose"
                                    id="brillinta_dosage1"
                                    className="pull-right"
                                    onChange={(e) => this.setState({ drug3: '60 mg' })}
                                    onClick={this.brillinta_dose2}
                                />
                                <br />
                                ...
                                <input
                                    type="radio"
                                    name="brillinta_dose"
                                    id="brillinta_dosage3"
                                    className="pull-right"
                                    onClick={this.brillinta_dose2}
                                />

                                <br />
                                <div className="row" id="brillinta_dose_other">
                                    <div className="col-6">
                                        <p className="blue" style={{ opacity: '0.5' }}>
                                            <b>Please specify dosage and frequency of DRUG</b>
                                        </p>
                                        ...
                                        <input
                                            type="text"
                                            id="brillinta_dose_other_opt"
                                            className="form-control mb-4 transparent-custom-input"
                                            placeholder="Dose (mg)"
                                            onChange={(e) =>
                                                this.setState({
                                                    drug3: e.target.value,
                                                })
                                            }
                                        />
                                        <div className="text-danger">
                                ...
                                <input
                                    type="radio"
                                    name="brillinta_dose_freq"
                                    id="brillinta_dose_freq1"
                                    className="pull-right"
                                ...
                                <input
                                    type="radio"
                                    name="brillinta_dose_freq"
                                    id="brillinta_dose_freq2"
                                    className="pull-right"
                                    onChange={(e) => this.setState({ frequency3: 'Not Sure' })}
                                />
                            ...
                            <div id="four">
                                ...
                                <br />
                                <div className="row" id="efffient_other">
                                    <p className="blue" style={{ opacity: '0.5' }}>
                                        <b>Please specify dosage and frequency of DRUG</b>
                                    </p>
                                    <input
                                ...
                                <input
                                    ...
                                    className="pull-right"
                                    onChange={(e) => this.setState({ frequency4: 'Not Sure' })}
                                />
                                <br />
                                <div className="text-danger">
                                    {' '}
    ...
    componentDidMount() {
        ...
        $('#brillinta_dosage3').click(function () {
            $('#brillinta_dose_other').toggle(1000);
        });
