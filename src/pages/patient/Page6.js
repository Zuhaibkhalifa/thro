            ...
            <div>
               ...
               <div className="bg-light blue-box">
                  ...
                  <form className="p-5" action="#!">
                     ...
                     <p className="blue">
                        <b>
                           Please specify the type of heart Valve Replacement technique that was
                           used
                        </b>
                     </p>
                     <label className="radio-inline blue">
                        <i className="fa fa-cog blue" aria-hidden="true" /> &nbsp; Mechanical Heart
                        valve
                     </label>
                     <input
                        type="checkbox"
                     ...
                     <br />
                     <label className="radio-inline blue">
                        <i className="fa fa-male blue" aria-hidden="true" /> &nbsp; Tissue Heart
                        Valve
                     </label>
                     <input
                        type="checkbox"
