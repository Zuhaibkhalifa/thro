...
class Page4 extends React.Component {
  ...
  try {
     axios.get('http://thrombolink.com/server/api/patient/page4LoadData',{
      headers: headers
    })
    .then((response) => {
...
submitForm() {
 ...
 } else if(document.getElementById("vte").checked === true && 
...
} else if(document.getElementById("optradio7").checked === true && 
  ...
  <div className="bg-light blue-box">
    ...
    <form id="pg4" className="p-5" action="#!">
      ...
      />
              ...
              <input type="checkbox" id="dvt_option1" name="dvt_option" className="pull-right" 
              onClick={this.onRadioBtn1}  onChange={(e)=>this.setState({q1_sub_q1_ans:'Yes'})}
              />
    <div id="toggle1">
              <p className="blue"><b>If So, how long ago</b></p>
              <label className="radio-inline blue">Less than 1 month ago</label>
              <input type="radio" name="dvt_sub_opt" id="dvt_option1" className="pull-right" 
              onChange={(e)=>this.setState({q1_sub_q1_ans_inner1:'Less than 1 month ago'})}
              />
              <br />
              <label className="radio-inline blue">Between 1 and 3 months ago</label>
              <input type="radio" name="dvt_sub_opt" className="pull-right" 
               onChange={(e)=>this.setState({q1_sub_q1_ans_inner1:'Between 1 and 3 months ago'})}
              />
              <br />
              <label className="radio-inline blue">More than 3 months ago</label>
              <input type="radio" name="dvt_sub_opt" className="pull-right" 
              onChange={(e)=>this.setState({q1_sub_q1_ans_inner1:'More than 3 months ago<'})}
              />
              <br />
              <label className="radio-inline blue">Not Sure</label>
              <input type="radio" name="dvt_sub_opt" className="pull-right" 
              onChange={(e)=>this.setState({q1_sub_q1_ans_inner1:'Not Sure'})}
              />
              ...
              <input type="checkbox" id="pe_option1" name="pe_option"className="pull-right" 
                 onClick={this.onRadioBtn2}  onChange={(e)=>this.setState({q1_sub_q2_ans:1})}
              />
            ...
            <div id="toggle2">
              <p className="blue"><b>If So, how long ago</b></p>
              <label className="radio-inline blue">Less than 1 month ago</label>
              <input type="radio" name="pe_sub_option" className="pull-right" 
               onChange={(e)=>this.setState({q1_sub_q2_ans_inner2:'Less than 1 month ago'})}
              />
              <br />
              <label className="radio-inline blue">Between 1 and 3 months ago</label>
              <input type="radio" name="pe_sub_option" className="pull-right" 
            onChange={(e)=>this.setState({q1_sub_q2_ans_inner2:'Between 1 and 3 months ago'})}
              />
              <br />
              <label className="radio-inline blue">More than 3 months ago</label>
              <input type="radio" name="pe_sub_option" className="pull-right" 
               onChange={(e)=>this.setState({q1_sub_q2_ans_inner2:'More than 3 months ago'})}
              />
              <br />
              <label className="radio-inline blue">Not Sure</label>
              <input type="radio" name="pe_sub_option" className="pull-right" 
      ...
      <input type="checkbox" name="optradio" className="pull-right" 
       ...
       onClick={this.showhide} id="mainOption2"
       />
      <br />
      ...
      <input type="checkbox" name="optradio" className="pull-right"
     value="1" defaultChecked={this.state.q4_ans === "1"}  onChange={(e)=>this.setState({q4_ans:'Yes',chkVal:1})}
      onClick={this.showhide} id="mainOption3"
       />
      <br />
      <label className="radio-inline blue">
        Arterial Peripheral Thrombosis
      </label>
      <input type="checkbox" name="optradio" className="pull-right" 
        onChange={(e)=>this.setState({q5_ans:'Yes',chkVal:1})}
        onClick={this.showhide} id="mainOption4"
      />
      <br />
      <label className="radio-inline blue">Peripheral arterial Disease</label>
      <input type="checkbox" name="optradio" className="pull-right" 
      onChange={(e)=>this.setState({q6_ans:'Yes',chkVal:1})}
      onClick={this.showhide} id="mainOption5"
      />
      <br />
      ...
      />
       <div id="de">
        ...
        <input
          ...
          defaultValue={this.state.q7_sub_ans} onChange={(e)=>this.setState({q7_sub_ans:e.target.value})}
        />
