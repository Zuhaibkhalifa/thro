   ...
   redirectNextPage() {
    ...
    submitForm() {
        if (
            ...
            document.getElementById('not_sure').checked === false &&
            document.getElementById('none').checked === false
        ) {
            this.setState({ error1: 'This field is required' });
        } else if (
            document.getElementById('drugs1').checked === true &&
            $('#drugs1_monday').val() === ''
        ) {
                ...
                <div className="bg-light blue-box">
                    ...
                    <form className="p-5" action="#!">
                        ...
                        <span id="q2_ans_days2">
                            ...
                            <div className="row">
                                ...
                                <div className="col-3">
                                    ...
                                    <div className="text-danger">
                                        {' '}
                                        {this.state.error12 !== '' ? this.state.error12 : ''}
                                    </div>
                                </div>
                            </div>
                            <br />
                            <div className="row">
                                <div className="col-3">
                                    ...
                                    <div className="text-danger">
                                        {' '}
                                        {this.state.error13 !== '' ? this.state.error13 : ''}
                                    </div>
                                </div>
                                <div className="col-3">
                                    <label className="blue" htmlFor="saturday">
                                    ...
                                    <div className="text-danger">
                                        {' '}
                                        {this.state.error14 !== '' ? this.state.error14 : ''}
                                    </div>
                                </div>
                                <div className="col-3">
                                    <label className="blue" htmlFor="sunday">
                                    ...
                                    <div className="text-danger">
                                        {' '}
                                        {this.state.error15 !== '' ? this.state.error15 : ''}
                                    </div>
                                </div>
                                <div className="col-3"></div>
                            </div>
                        ...
                        <input
                            ...
                            value="Not Sure"
                            onChange={this.toggle}
                            onClick={(e) => this.setState({ q1_ans: 'None of Above' })}
                        />
                        <br />
                        <div className="text-danger">
                            {' '}
