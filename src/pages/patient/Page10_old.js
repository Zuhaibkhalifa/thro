    ...
    <div className="row">
      ...
      <div className="col-3">
        ...
        <input
          ...
          id="other"
          className="form-control mb-4 transparent-custom-input"
          onChange={(e)=>this.setState({q1_ans_other:e.target.value})}
        />
...
<span id="q2_ans_days2">
    ...
    <div className="row">
      <div className="col-3">
        ...
        />
          {this.validator.message('Field', this.state.q2_ans_monday, 'required')}
      </div>
      <div className="col-3">
        <label className="blue" htmlFor="tuesday">
          Tuesday
      ...
      onChange={(e)=>this.setState({q2_ans_tuesday:e.target.value})}
        />
          {this.validator.message('Field', this.state.q2_ans_tuesday, 'required')}
      </div>
      <div className="col-3">
        <label className="blue" htmlFor="wednesday">
          Wednesday
        ...
        />
          {this.validator.message('Field', this.state.q2_ans_wednesday, 'required')}
      </div>
      <div className="col-3">
        <label className="blue" htmlFor="thursday">
          Thursday
        ...
        />
          {this.validator.message('Field', this.state.q2_ans_thursday, 'required')}
      </div>
    </div>
    <br />
    <div className="row">
      <div className="col-3">
        ...
        />
          {this.validator.message('Field', this.state.q2_ans_friday, 'required')}
      </div>
      <div className="col-3">
        <label className="blue" htmlFor="saturday">
          Saturday
       ...
       onChange={(e)=>this.setState({q2_ans_saturday:e.target.value})}
        />
          {this.validator.message('Field', this.state.q2_ans_saturday, 'required')}
      </div>
      <div className="col-3">
        <label className="blue" htmlFor="sunday">
          Sunday
        ...
        />
          {this.validator.message('Field', this.state.q2_ans_sunday, 'required')}
      </div>
      <div className="col-3">
        <label className="blue" htmlFor="other">
          Other
        ...
        <input
          ...
          id="other"
          className="form-control mb-4 transparent-custom-input"
          onChange={(e)=>this.setState({q2_ans_other:e.target.value})}
        />
