                        ...
                        <table style={{ display: "inline-table", textAlign: 'center' }} className="table-responsive table-bordered">
                           <tr style={{ borderBottom: "1px solid #ccc" }}>
                              ...
                              <th>Lab</th>
                              {
                                 ...
                                 <th colSpan={2}>
                                    {this.state.table.headers.find(x => x['vka']).vka[0].med_name}
                                 </th> : <></>
                              }
                              {
                                 this.state.doac_chkBox ?
                                 <th colSpan={2}>
                                    {this.state.table.headers.find(x => x['doac']).doac[0].med_name}
                                 </th> : <></>
                              }
                              {
                              ...
                              }
                              {
                                 ...
                                 <th colSpan={2}>
                                    {this.state.table.headers.find(x => x['lmwh']).lmwh[0].med_name}
                                 </th> : <></>
                              }
                              {
