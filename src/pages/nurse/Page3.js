                     ...
                     <div className="col-6">
                        <div className="form-group">
                           ...
                           <select
                              ...
                              onChange={(event) =>
                                 this.handle_procedure(event.target.value)
                              }
                           >
                              <option value="Select Surgery">
                                 Select Surgery
                              </option>
                              <optgroup label="Neurosurgery/Spine">
                                 <option
                                    value="Neuraxial procedure (high)
"
                                 >
                                    Neuraxial procedure (high)
                                 </option>
                                 <option
                                    value="Neurosurgery or Spinal Surgery (high)
"
                                 >
                              ...
                              <optgroup label="GI/abdominal">
                                 <option value="Abdominal surgery (mod)">
                                    Abdominal surgery (mod)
                                 </option>
                                 ...
                                 <option value="Extensive cancer surgery (e.g. liver/pancreas) (high)">
                                    Extensive cancer surgery (e.g.
                                    liver/pancreas) (high)
                                 </option>
                              </optgroup>

                              <optgroup label="Lung/Thoracic (non-cardiac)">
                                 <option value="Lung resection (high)">
                                    Lung resection (high)
                                 </option>
                              ...
                              <optgroup label="Eye">
                                 <option value="Cataract surgery (low)">
                              ...
                              <optgroup label="Dental">
                                 <option value="Complex dental procedure (e.g. multiple tooth extractions) (mod)">
                                    ...
                                    tooth extractions) (mod)
                                 </option>
                                 <option value="Dental other than multiple tooth extractions or maxillofacial surgery (low)">
                                    Dental other than multiple tooth extractions
                                    or maxillofacial surgery (low)
                                 </option>
                              </optgroup>
                              <optgroup label="Plastic surgery">
                                 ...
                                 <option value="Other plastic surgery">
                                    Other plastic surgery
                                 </option>
                              </optgroup>
                              <optgroup label="Cardiac or vascular">
                                 <option value="Cardiac surgery (high)">
                                    Cardiac surgery (high)
                                 </option>
                                 ...
                                 <option value="Permanent pacemaker or ICD placement (if patient is on apixaban, edoxaban, rivaroxaban, or dabigatran – mod, if on any other drugs - low)">
                                    Permanent pacemaker or ICD placement (if
                                    patient is on apixaban, edoxaban,
                                    rivaroxaban, or dabigatran – mod, if on any
                                    other drugs - low)
                                 </option>
                                 <option value="Major vascular surgery (aortic aneurysm repair, aortofemoral bypass) (high)">
                                    ...
                                    repair, aortofemoral bypass) (high)
                                 </option>
                              ...
                              <optgroup label="Needle biopsy">
                                 <option value="Kidney biopsy (high)">
                                    Kidney biopsy (high)
                                 </option>
                                 <option value="Prostate biopsy (high)">
                                    Prostate biopsy (high)
                                 </option>
                                 <option value="Cervical cone biopsy (high)">
                                    Cervical cone biopsy (high)
                                 </option>
                                 <option value="Pericardiocentesis (high)">
                                    Pericardiocentesis (high)
                                 </option>
                                 <option value="Colonic polypectomy (high)">
                                    Colonic polypectomy (high)
                                 </option>
                                 <option value="Bone marrow biopsy (mod)">
                                    Bone marrow biopsy (mod)
                                 </option>
                                 <option value="Lymph node biopsy (mod)">
                                    Lymph node biopsy (mod)
                                 </option>
                                 <option value="Low-risk procedures (e.g. thoracentesis, paracentesis, arthrocentesis) (low)">
                                    Low-risk procedures (e.g. thoracentesis,
                                    paracentesis, arthrocentesis) (low)
                                 </option>
                              </optgroup>

                              <optgroup label="Urological">
                                 <option value="Urological surgery (high)">
                                    Urological surgery (high)
                                 </option>
                              </optgroup>
                              <optgroup label="Urological">
                  ...
                  <div className="row">
                     ...
                     <div className="col-4">
                        ...
                        <h6 className="text-center">
                           {this.state.had_transfusion_in_last_three_months} at{" "}
                           {
                              this.state
                                 .had_transfusion_in_last_three_months_when
                           }
                     ...
                     <div className="col-12">
                        <span>
                           ...
                           <input
                              ...
                              onChange={(e) =>
                                 this.setState({ completed_by: e.target.value })
                              }
                              id="completed_by"
                           />
                        </span>
