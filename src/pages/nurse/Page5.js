         ...
         axios
            ...
            .then((response) => {
               ...
               if (data !== undefined) {
                  ...
                  this.state = {
                     who_is_completing_this_form:
                        data.who_is_completing_this_form,
               ...
               <div className="jumbotron">
                     ...
                     <div className="col-6">
                        <div className="custom-control custom-radio">
                           <input
                              ...
                              value="Son / Daughter"
                              defaultChecked={
                                 this.state.patient_accompanied_by ===
                                 "Son / Daughter"
                              }
                              onChange={(e) =>
                                 this.setState({
                  ...
                  <div className="custom-control custom-radio">
                     <input
                        ...
                        name="q3"
                        onChange={(e) =>
                           this.setState({ lmwh: "No bridging required" })
                        }
                     />
                     ...
                     <div className="col-6">
                        ...
                        <div className="custom-control custom-radio">
                           <input
                              ...
                              name="administration"
                              onChange={(e) =>
                                 this.setState({ administration: "Self" })
                              }
                           />
                           <label
                              className="custom-control-label"
                        ...
                        <div className="custom-control custom-radio">
                           <input
                              ...
                              name="administration"
                              onChange={(e) =>
                                 this.setState({ administration: "CCAC" })
                              }
                           />
                           <label
                              className="custom-control-label"
                     ...
                     <div className="col-6">
                        ...
                        <div className="custom-control custom-radio">
                           <input
                              ...
                              name="understanding"
                              onChange={(e) =>
                                 this.setState({ understanding: "Good" })
                              }
                           />
                           <label
                              className="custom-control-label"
                        ...
                        <div className="custom-control custom-radio">
                           <input
                              ...
                              name="understanding"
                              onChange={(e) =>
                                 this.setState({ understanding: "Fair" })
                              }
                           />
                           <label
                              className="custom-control-label"
                        ...
                        <div className="custom-control custom-radio">
                           <input
                              ...
                              name="understanding"
                              onChange={(e) =>
                                 this.setState({ understanding: "Poor" })
                              }
                           />
                           <label
                              className="custom-control-label"
