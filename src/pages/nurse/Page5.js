...
class Page5 extends React.Component {
  constructor(props) {
    ...
    this.state = { who_is_completing_this_form: '',
     ...
     lmwh: '',
      administration: '',
       understanding: '',explained: '',loader:1 };
    ...
    try {
       ...
       axios.get('http://thrombolink.com/server/api/nurse/page3LoadData',{
        headers: headers
      })
      .then((response) => {
...
this.state = { who_is_completing_this_form: data.who_is_completing_this_form,
patient_accompanied_by: data.patient_accompanied_by, 
lmwh: data.lmwh,
 administration: data.administration,
  understanding: data.understanding,explained: data.explained };
...
<div className="centered"><ReactSpinner type="border" color="blue" size="5"  /></div> :''
  ...
  <div className="jumbotron">
      ...
      <div className="col-6">
        <div className="custom-control custom-radio">
          <input
           ...
           onChange={(e)=>this.setState({who_is_completing_this_form:'MD'})}

          />
          <label className="custom-control-label" htmlFor="who_is_completing_this_form1">
            MD
          </label>
        </div>
      </div>
      <div className="col-6">
        <div className="custom-control custom-radio">
          <input
            ...
            name="who_is_completing_this_form"
            onChange={(e)=>this.setState({who_is_completing_this_form:'Nurse'})}

          />
          <label className="custom-control-label" htmlFor="who_is_completing_this_form2">
            Nurse
          </label>
        </div>
      </div>
      ...
      <div className="col-6">
        <div className="custom-control custom-radio">
          <input
            ...
            name="who_is_completing_this_form"
           onChange={(e)=>this.setState({who_is_completing_this_form:'Family Member'})}

          />
          <label className="custom-control-label" htmlFor="who_is_completing_this_form3">
            Family Member
          </label>
        </div>
      </div>
      <div className="col-6">
        <div className="custom-control custom-radio">
          <input
            ...
            name="who_is_completing_this_form"
          onChange={(e)=>this.setState({who_is_completing_this_form:'Other'})}

          />
          <label className="custom-control-label" htmlFor="who_is_completing_this_form4">
            Other
          </label>
        </div>
    ...
    {this.validator.message('', this.state.who_is_completing_this_form, 'required')}
    <br />
        ...
        <div className="custom-control custom-radio">
          <input
            ...
            name="patient_accompanied_by"
               value="Spouse" defaultChecked={this.state.patient_accompanied_by === "Spouse"}  onChange={(e)=>this.setState({patient_accompanied_by:'Spouse'})}

          />
          <label className="custom-control-label" htmlFor="patient_accompanied_by1">
            Spouse
          </label>
        </div>
      </div>
      <div className="col-6">
        <div className="custom-control custom-radio">
          <input
            ...
            name="patient_accompanied_by"
               value="Son / Daughter" defaultChecked={this.state.patient_accompanied_by === "Son / Daughter"}  onChange={(e)=>this.setState({patient_accompanied_by:'Son / Daughter'})}

          />
          <label className="custom-control-label" htmlFor="patient_accompanied_by2">
            Son / Daughter
          </label>
        </div>
      </div>
      ...
      <div className="col-6">
        <div className="custom-control custom-radio">
          <input
            ...
            name="patient_accompanied_by"
               value="Alone" defaultChecked={this.state.patient_accompanied_by === "Alone"}  onChange={(e)=>this.setState({patient_accompanied_by:'Alone'})}

          />
          <label className="custom-control-label" htmlFor="patient_accompanied_by3">
            Alone
          </label>
        </div>
      </div>
      <div className="col-6">
        <div className="custom-control custom-radio">
          <input
            ...
            name="patient_accompanied_by"
               value="Other" defaultChecked={this.state.patient_accompanied_by === "Other"}  onChange={(e)=>this.setState({patient_accompanied_by:'Other'})}

          />
          <label className="custom-control-label" htmlFor="patient_accompanied_by4">
            Other
          </label>
        </div>
      </div>
...
<input
  ...
  id="q3_1"
  name="q3"
      onChange={(e)=>this.setState({lmwh:'Instruction given with LMWH'})}
...
<input
  ...
  id="q3_2"
  name="q3"
 onChange={(e)=>this.setState({lmwh:'Has previously self-inject LMWH'})}
...
<input
  ...
  id="explained1"
  name="explained"
      onChange={(e)=>this.setState({explained:'Risk / Benefits explained'})}
    ...
    <div className="row">
      ...
      <h4>Administration</h4>
        ...
        <input
          ...
          />
          <label className="custom-control-label" htmlFor="administration1">
            Self
          </label>
        ...
        <div className="custom-control custom-radio">
          <input
            ...
            id="administration2"
            name="administration"
          onChange={(e)=>this.setState({administration:'Family'})}

          />
          <label className="custom-control-label" htmlFor="administration2">
            Family
          </label>
        </div>
        ...
        <div className="custom-control custom-radio">
          ...
          />
          <label className="custom-control-label" htmlFor="administration3">
          CCAC
          </label>
        </div>
      ...
      <h4>Understanding</h4>
        ...
        <div className="custom-control custom-radio">
          ...
          />
          <label className="custom-control-label" htmlFor="understanding41">
            Good
          </label>
        </div>
        <div className="custom-control custom-radio">
          ...
          />
          <label className="custom-control-label" htmlFor="understanding422">
            Fair
          </label>
        </div>
        <div className="custom-control custom-radio">
          ...
          />
          <label className="custom-control-label" htmlFor="understanding5">
            Poor
          </label>
        </div>
