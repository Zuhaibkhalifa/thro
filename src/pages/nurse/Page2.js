...
class Page2 extends React.Component {
  constructor(props) {
    ...
    try {
       ...
       axios.get('http://thrombolink.com/server/api/nurse/page1LoadData',{
        headers: headers
      })
      .then((response) => {
...
page1(param){
  var param={
    ...
    referred_by:this.state.referred_by,cabg:this.state.cabg
}
console.log(param);
...
<div className="centered"><ReactSpinner type="border" color="blue" size="5"  /></div> :''
  ...
  <div className="jumbotron">
    ...
    <div className="row">
      ...
      <div className="col-6">
        <div className="form-group">
          ...
          <input type="text" id="referred_by" className="form-control"  onChange={(e)=>this.setState({referred_by:e.target.value})}
      />
    ...
    <div className="form-group" id="cabg_div">
      ...
      <input type="text" className="form-control" id="usr"  defaultValue={this.state.cabg} onChange={(e)=>this.setState({cabg:e.target.value})}
      />
