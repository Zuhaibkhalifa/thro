...
class Page4_old extends React.Component {
  constructor(props) {
    ...
    this.state = { seen_by: '', assessment_by_doctor: '', study_by: '', study_result: '',comments: '',loader:0 };
  ...
  <div className="jumbotron">
    ...
    <div className="row">
      ...
      <div className="col-5">
        <div className="form-group">
          ...
          />
           {this.validator.message('seen_by', this.state.seen_by, 'required')}
        </div>
      </div>
    </div>
    <br />
    ...
    <div className="custom-control custom-radio">
      <input
        ...
        value="Schulman" defaultChecked={this.state.assessment_by_doctor === "Schulman"}  onChange={(e)=>this.setState({assessment_by_doctor:"Schulman"})}
    ...
    <div className="custom-control custom-radio">
      <input
        ...
        name="assessment_by_doctor"
        value="Eikelboom" defaultChecked={this.state.assessment_by_doctor === "Eikelboom"}  onChange={(e)=>this.setState({assessment_by_doctor:"Eikelboom"})}
      />
    ...
    <div className="custom-control custom-radio">
      <input
        ...
        name="assessment_by_doctor"
        value="Douketis" defaultChecked={this.state.assessment_by_doctor === "Douketis"}  onChange={(e)=>this.setState({assessment_by_doctor:"Douketis"})}
      />
      <label className="custom-control-label" htmlFor="assessment_by_doctor3">
        Douketis
      </label>
       {this.validator.message('', this.state.assessment_by_doctor, 'required')}
    </div>
    <br />
    <hr />
    <br />
    <div className="row">
      ...
      <div className="col-5">
        <div className="form-group">
          ...
          onChange={(e)=>this.setState({study_by:e.target.value})}
          />
    ...
    <div className="custom-control custom-radio">
      <input
        ...
        id="study_result1"
        name="study_result"
        value="Consented" defaultChecked={this.state.study_result === "Consented"}  onChange={(e)=>this.setState({study_result:"Consented"})}
      />
    ...
    <div className="custom-control custom-radio">
      <input
        ...
        id="study_result2"
        name="study_result"
        value="Consented" defaultChecked={this.state.study_result === "Declined"}  onChange={(e)=>this.setState({study_result:"Declined"})}
      />
    ...
    <div className="custom-control custom-radio">
      <input
        ...
        id="study_result3"
        name="study_result"
        value="Not Eliginble" defaultChecked={this.state.study_result === "Not Eliginble"}  onChange={(e)=>this.setState({study_result:"Not Eliginble"})}
      />
