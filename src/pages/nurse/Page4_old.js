               ...
               <div className="jumbotron">
                     ...
                     <div className="col-5">
                        <div className="form-group">
                           <input
                              ...
                              onChange={(e) =>
                                 this.setState({ seen_by: e.target.value })
                              }
                           />
                  ...
                  <div className="custom-control custom-radio">
                     <input
                        ...
                        value="Schulman"
                        defaultChecked={
                           this.state.assessment_by_doctor === "Schulman"
                        }
                        onChange={(e) =>
                  ...
                  <div className="custom-control custom-radio">
                     <input
                        ...
                        value="Eikelboom"
                        defaultChecked={
                           this.state.assessment_by_doctor === "Eikelboom"
                        }
                        onChange={(e) =>
                  ...
                  <div className="custom-control custom-radio">
                     <input
                        ...
                        value="Douketis"
                        defaultChecked={
                           this.state.assessment_by_doctor === "Douketis"
                        }
                        onChange={(e) =>
                  ...
                  <div className="custom-control custom-radio">
                     <input
                        ...
                        onChange={(e) =>
                           this.setState({ study_result: "Consented" })
                        }
                     />
                     <label
                        className="custom-control-label"
                        htmlFor="study_result1"
                     >
                        Consented
                     </label>
                  </div>
                  <div className="custom-control custom-radio">
                     <input
                        ...
                        onChange={(e) =>
                           this.setState({ study_result: "Declined" })
                        }
                     />
                     <label
                        className="custom-control-label"
                        htmlFor="study_result2"
                     >
                        Declined
                     </label>
                  </div>
                  <div className="custom-control custom-radio">
                     <input
                        ...
                        value="Not Eliginble"
                        defaultChecked={
                           this.state.study_result === "Not Eliginble"
                        }
                        onChange={(e) =>
                           this.setState({ study_result: "Not Eliginble" })
                        }
                     />
                     <label
                        className="custom-control-label"
                        htmlFor="study_result3"
                     >
                        Not Eliginble
                     </label>
                     {this.validator.message(
                        "",
                        this.state.study_result,
                        "required"
                     )}
                  </div>
                  <br />
