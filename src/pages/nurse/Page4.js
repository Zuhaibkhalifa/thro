...
class Page4 extends React.Component {
   ...
   async getDatafromAlgo() {
      ...
      if(tableData.vka !== undefined) {
         ...
         console.log("warfain indexs ==> ",keyIdx1, tableData.vka.data[0].warfain);
         if(keyIdx1 !== -1) {
      ...
      if(Object.keys(tableData.doac)[0] !== 'data') {
         ...
         if(keyId1 !== '') {
            ...
            if(tableData.doac[doacKey]?.note1) {
               this.setState({
                  cell: 
                  {
                     ...this.state.cell,
      ...
      if(tableData.antiplatelets !== undefined) {
         ...
         if(keyId1 !== '') {
            if(keyIdx1 !== -1) {
               ...
               if(tableData.antiplatelets?.note1) {
                  this.setState({
                     cell: 
                     {
                        ...this.state.cell,
