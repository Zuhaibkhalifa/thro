...
class Nurse_section_five extends Model
{
   protected $fillable = [
    ...
    'chads_score_and_distribution', 'poc_inr_date', 'poc_creat_date',  'hb_date', 'plt_date', 
    'poc_inr_text', 'poc_creat_text',  'hb_text', 'plt_text', 'details_on_recomemendation','user_id'
    ];
